...
//                 {
//                     ParentObject.Render.DisplayName = ("&M")
...
//                     if (ParentObject.GetPrimaryFaction().Contains("BraversSaltBack"))
//                         ParentObject.RequirePart<Epithets>().Primary = (" of the Amethyst Shell Goyo-Ryu");
//                     if (ParentObject.GetPrimaryFaction().Contains("BraversSaltHopper"))
//                         ParentObject.RequirePart<Epithets>().Primary = (" of the Scythe-Strike Ryu");
//                     if (ParentObject.GetPrimaryFaction().Contains("BraversAstralCabby"))
//                         ParentObject.RequirePart<Epithets>().Primary = (" of the Void-Claw Ryu");
//                     if (ParentObject.GetPrimaryFaction().Contains("BraversSlumber"))
